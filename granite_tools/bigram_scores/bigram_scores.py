...
# TODO: Is this function needed? The bigrams should be saved in separate single JSON
# file now.
def load_bigram_scores(
    ...
    raw_anchor_scores_file:
        ...
        for certain anchor bigrams. Example key-value pair:
