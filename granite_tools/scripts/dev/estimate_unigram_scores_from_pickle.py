...
Usage: python granite_tools/scripts/dev/estimate_unigram_scores.py <some.compare.pickle> [config_file.yml]

NOTE: This gives very preliminary results. Use the estimate_unigram_scores.py script for
